<?php 
	...
	function create_password ( $user, $pass ) {
		...
		//
		$mypasswd = $user.$pass;
		$salt = substr(md5(mt_rand()), 0, 22); // Generate a random salt
		$hashed_password = crypt($password, '$2y$10$' . $salt); // Use a Blowfish salt
