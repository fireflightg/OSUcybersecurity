<?php 
	...
	function redirect_to_page( $relative_url = "index.php" ) {
	...
	// CGI Functions
	$pages = array( "add", "add_static", "add_block", "add_link", "categories", "colors", "comments", "delete", "delete_static", "image_list", "info", "index", "static", "rating", "login", "logout", "forms", "set_login", "install00", "install01", "install02", "install03", "setup", "trackbacks ", "options", "themes", "upload_img", "search", "contact" );
	if ( array_key_exists( "blog_language1", $_POST ) ) {
	
		// Store all the data from language 1
		require("languages/" . $_POST[ "blog_language1" ] . "/strings.php");
		...
		redirect_to_page( "languages_cgi.php?store_data=1&lang2=" . $_POST[ "blog_language2" ] . "&lang1=" . $_POST[ "blog_language1" ] );
		
	} else {
		if ( array_key_exists( "store_data", $_GET ) ) {
		
			// Store all the data from language 2
			require("languages/" . $_GET[ "lang2" ] . "/strings.php");
			...
			redirect_to_page( "languages_cgi.php?display_results=1&lang2=" . $_GET[ "lang2" ] . "&lang1=" . $_GET[ "lang1" ] );
